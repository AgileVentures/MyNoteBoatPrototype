...
export default class TestNavLightsScreen extends React.Component {
  ...
  async onPress() {
    ...
    if (value) { // if validation fails, value will be null
      ...
      try {
        await AsyncStorage.setItem('@MyNoteBoatStore:TestNavLights:editable', JSON.stringify(value));
        await AsyncStorage.setItem('@MyNoteBoatStore:TestNavLights:fixed', new Date().toLocaleDateString('fr-FR'));
      } catch (error) {
