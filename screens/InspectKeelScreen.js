...
export default class InspectKeelScreen extends React.Component {
  static navigationOptions = {
    title: 'Inspection de la Quille',
  };
  ...
  async onPress() {
    ...
    if (value) { // if validation fails, value will be null
      ...
      try {
        await AsyncStorage.setItem('@MyNoteBoatStore:InspectKeel:editable', JSON.stringify(value));
        await AsyncStorage.setItem('@MyNoteBoatStore:InspectKeel:fixed', new Date().toLocaleDateString('fr-FR'));
      } catch (error) {
  ...
  render() {
    ...
    return (
      ...
      <Text style={styles.heading}>Inspection de la Quille</Text>
         <Text style={styles.itemText}>Inspection visuelle des boulons de quille.</Text>
         <Text style={styles.itemText}>Recherche des trace d’oxydation.</Text>
         <Text style={styles.itemText}>Contrôler le serrage.des boulons.</Text>
